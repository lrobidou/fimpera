...
int main(int argc, char* argv[]) {
    ...
    program.add_argument("size").help("output index size").scan<'i', int>();
    // optional arguments
    ...
    fimpera<countingBF::CBF>
        f(program.get("input_filename"), program.get<int>("-K"), program.get<int>("-z"), program["--canonical"] == true, program.get<int>("size"), program.get<int>("-b"));
    // save it
