...
void fimpera_no_log(const std::string& kmc_filename_kmers, std::size_t size, int b, const std::string& filename_query) {
    ...
    fimpera<countingBF::CBF> cbf_0 = fimpera<countingBF::CBF>(strategy, kmc_filename_kmers, 31, 0, canonical, size, b, 1);
    ...
    std::cout << "[matrix cbf vs truth]" << std::endl;
...
int main(int argc, char* argv[]) {
    ...
    fimpera_no_log(kmc_filename_kmers, size, b, filename_query);
}
